...
public class SwiftPromptsView: UIView
{
    ...
    private var promptContentText : String = "This is prompt"
    ...
    private var mainButtonText : String = "Yes"
    private var secondButtonText : String = "No"
    ...
    override public func drawRect(rect: CGRect)
    {
        ...
        else
        {
            ...
            button.setTitle(mainButtonText, forState: UIControlState.Normal)
            button.tag = 1
            button.addTarget(self, action: "mainButtonAction:", forControlEvents: UIControlEvents.TouchUpInside)
            ...
            secondButton.tag = 2
            secondButton.addTarget(self, action: "secondButtonAction:", forControlEvents: UIControlEvents.TouchUpInside)
    ...
    */
    func mainButtonAction(sender: UIButton?) {
        ...
        ComputerRuntimeVariables.PromptLink = 1
    }
