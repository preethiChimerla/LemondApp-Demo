...
class LeftArrow: UIView {
    override func drawRect(rect: CGRect) {
        ...
        CGContextTranslateCTM(context, 25.76, 43.58)
        ...
        bezierPath.moveToPoint(CGPointMake(23.18, 19.86))
        
        bezierPath.addLineToPoint(CGPointMake(4.02, 0.69))
        
        bezierPath.addCurveToPoint(CGPointMake(1.45, 0.18), controlPoint1: CGPointMake(3.34, 0.02), controlPoint2: CGPointMake(2.33, -0.19))
        
        bezierPath.addCurveToPoint(CGPointMake(0, 2.35), controlPoint1: CGPointMake(0.57, 0.54), controlPoint2: CGPointMake(0, 1.4))
        
        bezierPath.addLineToPoint(CGPointMake(10.05, 21.52))
        
        bezierPath.addLineToPoint(CGPointMake(0, 40.68))
        
        bezierPath.addCurveToPoint(CGPointMake(1.45, 42.86), controlPoint1: CGPointMake(0, 41.64), controlPoint2: CGPointMake(0.57, 42.49))
        
        bezierPath.addCurveToPoint(CGPointMake(2.35, 43.04), controlPoint1: CGPointMake(1.74, 42.98), controlPoint2: CGPointMake(2.05, 43.04))
        
        bezierPath.addCurveToPoint(CGPointMake(4.02, 42.35), controlPoint1: CGPointMake(2.96, 43.04), controlPoint2: CGPointMake(3.56, 42.8))
        
        bezierPath.addLineToPoint(CGPointMake(23.18, 23.18))
        
        bezierPath.addCurveToPoint(CGPointMake(23.87, 21.52), controlPoint1: CGPointMake(23.62, 22.74), controlPoint2: CGPointMake(23.87, 22.14))
        
        bezierPath.addCurveToPoint(CGPointMake(23.18, 19.86), controlPoint1: CGPointMake(23.87, 20.9), controlPoint2: CGPointMake(23.62, 20.29))
